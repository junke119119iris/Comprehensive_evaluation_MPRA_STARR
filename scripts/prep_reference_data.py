...
data_path = os.path.join(project_root, 'data', 'Reference', 'K562_GRO_cap', 'GRO_cap_element',
                         'processed_files', 'GROcap_elements_all.bed')
gro_cap_element_all.to_csv(data_path, sep='\t', index=False, header=False)
...
ccre_df.to_csv(data_path, sep='\t', index=False, header=False)
